...
class Knockoff(nn.Module):
    def __init__(self, method, dataset, bit, knockoffs_path, dataset_path):
        ...
        if self.method == 'DCMH':
            load_img_path = knockoffs_path + str(self.method) + '_' + self.dataset + '_' + str(self.bit) + '/image_model.pth'
            load_txt_path = knockoffs_path + str(self.method) + '_' + self.dataset + '_' + str(self.bit) + '/text_model.pth'
            from knockoffs.DCMH.img_module import ImgModule
            from knockoffs.DCMH.txt_module import TxtModule
        ...
        if self.method == 'CPAH':
            CPAH_path = knockoffs_path + str(self.method) + '_' + self.dataset + '_' + str(self.bit) + '/CPAH.pth'
            image_dim = 4096
            hidden_dim = 512
        ...
        if self.method == 'DADH':
            DADH_path = knockoffs_path + str(self.method) + '_' + self.dataset + '_' + str(self.bit) + '/DADH.pth'
            dropout = False
            image_dim = 4096
            hidden_dim = 8192
